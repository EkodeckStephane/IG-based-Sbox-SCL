...
this separation is not a new S-box ranking by a single scalar.  It is a
...
pairwise-gap tables identify the hard key differences under the assumed CPA
model, which is the security-relevant information hidden by scalar
amplitude-only summaries.
\end{enumerate}
